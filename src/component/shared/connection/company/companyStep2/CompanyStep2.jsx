        ...
        <div className="extranet-companyStep2">
            ...
            <div className="extranet-companyStep2-body">
                ...
                <div className="extranet-companyStep2-body-container">
                    ...
                    <Select className="app-publication-form-info-body-group_select" placeholder={"Sélectionnez un secteur"}>
                ...
                <div className="extranet-companyStep2-body-container">
                    ...
                    <input className="extranet-companyStep2-body-container_input" type="text" name="" id="" placeholder="contact@entreprise.com" />
                </div>
