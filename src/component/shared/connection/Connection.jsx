...
export default function Connection() {
    ...
    return (
        <>
            ...
            : stepCompany == 1 ?
                <CompanyStep1 stepCompany={stepCompany} handleAddCompany={handleAddCompany} handleRemoveCompany={handleRemoveCompany}  />
            : stepCompany == 2 ?
                <CompanyStep2 stepCompany={stepCompany} handleRemoveCompany={handleRemoveCompany}  />
            :
